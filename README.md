...
```
    ...
    The rule in natural language is the following: IF Gas Is Recognized At Coordinates AND Fire Is Recognized At these Coordinates AND Agents Is Nearby to these Coordinates THEN Send Alert to these Agents AND Agents Abort Mission.
